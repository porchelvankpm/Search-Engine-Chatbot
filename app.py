...
st.title(" Lang chain - Chat with search   ")

st.sidebar.title("Settings")
api_key = st.sidebar.text_input("Entet your groq API key:", type='password')

## creating session state for display what this chatbot will do
